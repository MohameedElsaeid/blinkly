...
import { Link2, BarChart3, QrCode, Shield, Zap, Globe, Clock, Share2, Layers, Settings, Chrome } from "lucide-react";
    ...
    <div id="features" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl overflow-hidden shadow-xl mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="p-10 lg:p-12 flex flex-col justify-center">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-900">Everything you need for link optimization</h3>
              
              <p className="text-gray-600 mb-8">
                Blinkly brings together all the essential tools for effective link management, tracking, and optimization in one powerful platform. From custom branding to detailed performance analysis, we've got you covered.
              </p>
                ...
                {secondaryFeatures.slice(0, 3).map((feature, index) => (
                  <li key={index} className="flex items-start">
                    <div className="flex-shrink-0 mr-3 mt-1">
                      <div className="w-6 h-6 rounded-full bg-blinkly-green/10 flex items-center justify-center">
              ...
              <div className="relative rounded-xl overflow-hidden shadow-lg w-full">
                ...
                <div className="absolute bottom-4 right-4 bg-white rounded-lg shadow-lg p-4">
                  <div className="flex items-center">
                    <Settings className="h-6 w-6 text-blinkly-teal p-1 bg-blinkly-teal/10 rounded-full mr-2" />
        ...
        <div className="mt-16 text-center">
          <Button size="lg" className="bg-blinkly-purple hover:bg-blinkly-purple/90 text-white px-8 py-6 h-auto text-base shadow-md" asChild>
            <Link to="/signup">
