...
import {BarChart3, Check, Globe, Play, Shield, Users} from "lucide-react";
        ...
        <div className="relative overflow-hidden bg-gradient-to-b from-gray-50 to-white">
            ...
            <div className="relative z-10 pt-20 lg:pt-28 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 mb-6">
                            ...
                            <span
                                className="bg-gradient-to-r from-blinkly-purple to-blinkly-teal bg-clip-text text-transparent">
                elevate your brand
              </span>
                        </h1>

                        <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto lg:mx-0 mb-8">
                            Create memorable short links, gain powerful insights with real-time analytics, and connect
                            with your audience through custom QR codes.
                        </p>

                        <div
                            className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-12">
                            <Button size="lg"
                                    className="w-full sm:w-auto bg-blinkly-purple hover:bg-blinkly-purple/90 text-white px-8 py-6 h-auto text-base font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                                    asChild>
                                <Link to="/signup">
                                    Start for free
                                </Link>
                            ...
                            <Button size="lg" variant="outline"
                                    className="w-full sm:w-auto border-gray-300 text-gray-700 hover:bg-gray-50 px-8 py-6 h-auto text-base"
                                    asChild>
                        ...
                        {/* Trust Indicators */}
                        <div
                            className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-x-6 gap-y-2 text-sm text-gray-500">
                    ...
                    <div className="flex-1 w-full max-w-xl mx-auto lg:mx-0">
                        <div className="relative rounded-xl overflow-hidden shadow-2xl">
                            <div
                                className="absolute inset-0 bg-gradient-to-tr from-blinkly-purple/20 to-blinkly-teal/20 rounded-xl"></div>
                            <OptimizedImage
                            ...
                            <div className="absolute -bottom-3 -right-3 bg-white rounded-lg shadow-lg p-4 max-w-xs">
                                <div className="flex items-center">
                                    <BarChart3
                                        className="h-8 w-8 text-blinkly-purple p-1.5 bg-blinkly-purple/10 rounded-full mr-3"/>
                                    <div>
                ...
                <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                    <div
                        className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 flex flex-col items-center text-center">
                        <div
                            className="w-16 h-16 rounded-full bg-blinkly-purple/10 flex items-center justify-center mb-4">
                    ...
                    <div
                        className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 flex flex-col items-center text-center">
                        <div
                            className="w-16 h-16 rounded-full bg-blinkly-teal/10 flex items-center justify-center mb-4">
                    ...
                    <div
                        className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 flex flex-col items-center text-center">
                        <div
                            className="w-16 h-16 rounded-full bg-blinkly-orange/10 flex items-center justify-center mb-4">
