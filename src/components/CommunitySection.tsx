import {Activity, ArrowRight, Award, Globe, MessageSquare, Users} from "lucide-react";
        ...
        <section className="py-24 bg-gradient-to-b from-white to-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <div
                        className="inline-flex items-center px-4 py-2 rounded-full bg-blinkly-purple/10 text-blinkly-purple text-sm font-medium mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
                    {[
                        ...
                        <div key={index}
                            ...
                            <div
                                className={`w-14 h-14 mx-auto rounded-full ${stat.color} flex items-center justify-center mb-4`}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                    <div className="bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="p-8">
                            ...
                            <p className="text-gray-600 mb-6">
                                Connect with other Blinkly users to share tips, ask questions, and learn best practices
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={i} className="flex items-start">
                                        <div
                                            className="h-6 w-6 rounded-full bg-blinkly-purple/10 flex items-center justify-center text-blinkly-purple mr-3 mt-0.5">
                            ...
                            <div className="mt-8">
                                <Button variant="outline"
                                        className="group border-blinkly-purple text-blinkly-purple hover:bg-blinkly-purple/5"
                                        asChild>
                    ...
                    <div className="bg-white rounded-xl shadow-md overflow-hidden">
                        ...
                        <div className="p-8">
                            ...
                            <p className="text-gray-600 mb-6">
                                Join our regular webinars, workshops, and annual conferences to level up your link
                                management skills.
                            </p>
                ...
                <div className="bg-gradient-to-r from-blinkly-purple/10 to-blinkly-teal/10 rounded-2xl p-8 text-center">
                    ...
                    <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
                        Connect with thousands of marketers and businesses using Blinkly to transform their digital
                        presence.
                    </p>
