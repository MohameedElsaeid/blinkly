                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {testimonials.map((testimonial, index) => (
                        ...
                        >
                            {/* Quote symbol */}
                            <div
                                className="absolute -top-4 -left-4 w-8 h-8 rounded-full bg-blinkly-purple flex items-center justify-center text-white text-2xl font-serif">
                                "
                            </div>
                ...
                <div className="mt-16 bg-white rounded-2xl shadow-md overflow-hidden">
                    <div className="p-8 text-center">
                        <p className="text-2xl font-medium text-gray-700 mb-8">
                            Join over <span className="text-blinkly-purple font-bold">15,000+</span> businesses already
                            using Blinkly
                        </p>
