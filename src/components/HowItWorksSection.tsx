...
import { ArrowRight, Link2, BarChart3, QrCode, ChevronRight } from "lucide-react";
  ...
  return (
    <section id="how-it-works" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-10 left-full w-full h-0.5 bg-gray-200 z-0 -translate-y-1/2">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className={`${step.textColor} font-mono text-lg font-bold mb-2`}>{step.number}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="p-4 lg:p-12 flex flex-col justify-center">
              ...
              <p className="text-gray-600 mb-8">
                Our intuitive dashboard gives you complete control over your links and analytics. Create, manage, and track all your links in one place.
              </p>
              
              <div className="space-y-4 mb-6">
                <div className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-blinkly-purple/10 flex items-center justify-center text-blinkly-purple mr-3 mt-0.5">1</div>
                  <div>
                    <p className="font-medium text-gray-900">Intuitive Dashboard</p>
                    <p className="text-sm text-gray-600">All your links and analytics in one place</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-blinkly-purple/10 flex items-center justify-center text-blinkly-purple mr-3 mt-0.5">2</div>
                  <div>
                ...
                <div className="flex items-start">
                  <div className="h-6 w-6 rounded-full bg-blinkly-purple/10 flex items-center justify-center text-blinkly-purple mr-3 mt-0.5">3</div>
                  <div>
              ...
              <Button className="w-full sm:w-auto bg-blinkly-purple hover:bg-blinkly-purple/90 text-white" asChild>
                <Link to="/signup">
                  Try it for free
                </Link>
              </Button>
        ...
        {/* CTA Card */}
        <div className="text-center bg-gradient-to-r from-blinkly-purple/10 to-blinkly-teal/10 rounded-2xl p-8 lg:p-12">
          <h3 className="text-2xl font-bold mb-4 text-gray-900">Ready to get started?</h3>
          <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
            Join thousands of marketers and businesses who are already transforming their link strategy with Blinkly.
          </p>
