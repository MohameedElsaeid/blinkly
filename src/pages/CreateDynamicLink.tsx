...
import {ArrowRight, Globe, Image as ImageIcon, Link, Link2, Monitor, Smartphone, Upload} from "lucide-react";
                            ...
                            <div className="md:col-span-2">
                                <form onSubmit={handleSubmit} className="space-y-8">
                                        ...
                                        <CardContent className="space-y-6">
                                            ...
                                            <RadioGroup value={linkType} onValueChange={setLinkType}
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    <Label htmlFor="standard" className="font-medium">Standard
                                                        Link</Label>
                                                </div>
                                                <div className="flex items-center space-x-2">
                                                    <RadioGroupItem value="dynamic" id="dynamic"/>
                                                    <Label htmlFor="dynamic" className="font-medium">Dynamic Link
                                                        (Platform-Specific Redirection)</Label>
                                                </div>
                                            </RadioGroup>
                                    ...
                                    <Card>
                                        ...
                                        <CardContent className="space-y-6">
                                            <div className="space-y-2">
                                                <Label htmlFor="custom-alias" className="font-medium">Custom Alias
                                                    (Optional)</Label>
                                                <div className="flex">
                                                    <div
                                                        className="bg-muted px-3 py-2 text-sm rounded-l-md border border-r-0 border-input flex items-center">
                                                        blinkly.app/
                                                    </div>
                                                    <Input
                                                        id="custom-alias"
                                                ...
                                                <p className="text-sm text-muted-foreground">
                                                    A memorable branded alias for your link (leave empty for
                                                    auto-generated)
                                                </p>
                                            </div>

                                            <div className="space-y-2">
                                                <Label htmlFor="additional-params" className="font-medium">Additional
                                                ...
                                                />
                                                <p className="text-sm text-muted-foreground">
                                                    Query parameters for tracking or personalization (e.g., UTM
                                                    parameters)
                                                </p>
                                            </div>
                                        </CardContent>
                                            ...
                                            <Tabs defaultValue="social" className="w-full">
                                                ...
                                                <TabsContent value="social" className="mt-4">
                                                    <div className="border rounded-md overflow-hidden">
                                                        {imageUrl ? (
                                                            ...
                                                            <div
                                                                className="aspect-[1200/630] bg-muted flex items-center justify-center">
                                                                <ImageIcon
                                                        ...
                                                        <div className="p-3 bg-white border-t">
                                                            <div
                                                                className="text-xs text-muted-foreground mb-1">blinkly.app
                                                            </div>
                                                ...
                                                <TabsContent value="link" className="mt-4">
                                                    <div className="space-y-4">
                                                        <div
                                                            className="bg-muted p-3 rounded-md flex items-center gap-2">
                                                            <Link2 className="h-4 w-4 text-alchemy-purple shrink-0"/>
                                                            <span className="text-sm font-medium truncate">
                                blinkly.app/{customAlias || "your-link"}
                              </span>
                                                        </div>
                                                        ...
                                                        <div className="space-y-2">
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                <span
                                                                    className="text-xs truncate">{primaryUrl || "Primary URL"}</span>
                                                            </div>
                                                                ...
                                                                <>
                                                                    {mobileUrl && (
                                                                        <div className="flex items-center gap-2">
                                                                            ...
                                                                            <span
                                                                                className="text-xs truncate">{mobileUrl}</span>
                                                                        </div>
                                                                    )}
                                                                    ...
                                                                    {desktopUrl && (
                                                                        <div className="flex items-center gap-2">
                                                                            <Monitor
                                                                                className="h-4 w-4 text-muted-foreground"/>
                                                                            <span
                                                                                className="text-xs truncate">{desktopUrl}</span>
                                                                        </div>
                                                                    )}
                                                                </>
                                                            )}
